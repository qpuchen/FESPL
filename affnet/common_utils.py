...
from affnet.ddp_utils import is_master
...
def device_setup(opts):
    ...
    random_seed = getattr(opts, "affnet.common.seed", 0)
    ...
    if n_gpus == 0:
        ...
        allow_tf32 = not getattr(opts, "affnet.common.disable_tf32", False)
...
def is_coreml_conversion(opts) -> bool:
    if getattr(opts, "affnet.common.enable_coreml_compatible_module", False):
        return True
    return False
